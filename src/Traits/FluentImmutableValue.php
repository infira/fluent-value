 ...
 * @property-read $this convertCase - Convert the case of a string.
 * @method $this convertCase(int $mode = MB_CASE_FOLD, ?string $encoding = 'UTF-8') - Convert the case of a string.
 * @property-read $this deduplicate - Replace consecutive instances of a given character with a single character.
 * @method $this deduplicate(array|string $characters = ' ') - Replace consecutive instances of a given character with a single character.
 ...
 * @method $this limit($limit = 100, $end = '...', $preserveWords = false) - Limit the number of characters in a string.
 ...
 * @method $this markdown(array $options = [], array $extensions = []) - Convert GitHub flavored Markdown into HTML.
 * @property-read $this inlineMarkdown - Convert inline Markdown into HTML.
 * @method $this inlineMarkdown(array $options = [], array $extensions = []) - Convert inline Markdown into HTML.
 * @property-read $this numbers - Remove all non-numeric characters from a string.
 * @method $this numbers() - Remove all non-numeric characters from a string.
 * @property-read $this plural - Get the plural form of an English word.
 * @method $this plural($count = 2, $prependCount = false) - Get the plural form of an English word.
 ...
 * @property-read $this pluralPascal - Pluralize the last word of an English, Pascal caps case string.
 * @method $this pluralPascal($count = 2) - Pluralize the last word of an English, Pascal caps case string.
 ...
 * @property-read $this title - Convert the given string to proper case.
 * @method $this title() - Convert the given string to proper case.
 * @property-read $this headline - Convert the given string to proper case for each word.
 * @method $this headline() - Convert the given string to proper case for each word.
 * @property-read $this initials - Convert the given string to only its initials.
 * @method $this initials() - Convert the given string to only its initials.
 * @property-read $this apa - Convert the given string to APA-style title case.
 * @method $this apa() - Convert the given string to APA-style title case.
 * @property-read $this transliterate - Transliterate a string to its closest ASCII representation.
 * @method $this transliterate($unknown = '?', $strict = false) - Transliterate a string to its closest ASCII representation.
 ...
 * @method $this slug($separator = '-', $language = 'en', $dictionary = ['@' => 'at']) - Generate a URL friendly "slug" from a given string.
 ...
 * @property-read $this pascal - Convert the string to Pascal case.
 * @method $this pascal() - Convert the string to Pascal case.
 ...
 * @property-read $this ucwords - Capitalize the first character of each word in a string.
 * @method $this ucwords($separators = " \t\r\n\f\v") - Capitalize the first character of each word in a string.
 ...
 * @property-read $this wordWrap - Wrap a string to a given number of characters.
 * @method $this wordWrap($characters = 75, $break = "\n", $cutLongWords = false) - Wrap a string to a given number of characters.
 * @property-read $this toBase64 - Convert the string to Base64 encoding.
 * @method $this toBase64() - Convert the string to Base64 encoding.
 * @property-read $this fromBase64 - Decode the Base64 encoded string.
 * @method $this fromBase64($strict = false) - Decode the Base64 encoded string.
 * @property-read $this encrypt - Encrypt the string.
 * @method $this encrypt(bool $serialize = false) - Encrypt the string.
 * @property-read $this decrypt - Decrypt the string.
 * @method $this decrypt(bool $serialize = false) - Decrypt the string.
...
trait FluentImmutableValue
{
	 ...
	 * @generated
	 */
	public function wrap(string|array $before, string|array|null $after = null): static
	{
	 ...
	 * @generated
	 */
	public function removeVat(float|int|null $vatPercent = null): static
	{
	 ...
	 * @generated
	 */
	public function addVat(float|int|null $vatPercent = null): static
	{
	 ...
	 * @generated
	 */
	public function vat(bool $priceContainsVat, float|int|null $vatPercent = null): static
	{
	 ...
	 * @generated
	 */
	public function first(?callable $callback = null, mixed $default = null): static
	{
	 ...
	 * @generated
	 */
	public function last(?callable $callback = null, mixed $default = null): static
	{
